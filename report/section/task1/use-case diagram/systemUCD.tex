...
\subsection{Tổng quát của hệ thống}
    ...
    \begin{tblr}{
        ...
        Normal flow &   		1. Hệ thống hiển thị các tùy chọn quản lý tài nguyên \newline
    ...
    \begin{tblr}{
        ...
        Normal flow &   1. Người dùng ấn vào icon tài khoản \newline
    ...
    \begin{tblr}{
        ...
        Normal flow &   1. Hệ thống lấy thông tin về lý lịch của nhân viên \newline
                    	2. Hệ thống hiển thị giao diện thông tin chung \newline
                    	3. Công nhân xem thông tin của mình \\
        Alternative flow  & none \\
        Exception flow & none \\
    \end{tblr}
    ...
    \begin{tblr}{
        ...
        Normal flow &   1. Hệ thống lấy thông tin về lịch làm \newline
                    	2. Hệ thống hiển thị giao diện lịch làm việc \newline
                    	3. Công nhân xem lịch làm việc của mình \\
        Alternative flow  & none \\
        Exception flow & none \\
    \end{tblr}
